...
Let's make a second animation sequence - this time, when you click Scratch, let's make him glide 100 pixels to the right (X:100), and then say something.
...
----------------------------------------------------
3. If the cat is touching the boundary of the visible area
4. Turn the cat around 180 degrees
----------------------------------------------------
5. Move 50 steps
6. Go back to step 3
```
...
So far we've learned about events, loops, and control flow. Let's put it all together to build a simple maze application.
